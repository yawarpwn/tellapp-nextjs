	...
	return (
		<>
			...
			<div className="mt-4 flex items-center gap-4">
				<input name="customer-checkbox" className="checkbox checkbox-primary" defaultChecked type="checkbox" />
			...
			<section className="mt-4">
				<header className="flex items-center justify-between">
					...
					<button type="button" onClick={openItemModal} className="btn btn-primary">
						<PlusIcon />
						Agregar Item
					</button>
				</header>
				<ItemsTable items={quotation.items} onDelete={deleteItem} onEdit={openEditItemModal} />
				{state.errors?.items &&
