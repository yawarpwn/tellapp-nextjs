...
const PrintLabel = ({ label }) => {
	...
	const { dni_ruc, destination, recipient, phone, address, id, agencies } = label
	...
	return (
		<>
			...
			<div className="flex items-center  overflow-x-auto border">
				<div ref={containerRef} className="container-print flex flex-col border justify-between">
					{[1, 2, 3].map((_, index) => {
						return (
							<div
								key={index}
							...
							>
								<div className="flex flex-col justify-between">
									...
									<div className="flex justify-center items-center  p-3 ">
										<img src="/shipping-icons.svg" alt="" className="h-[48px]" />
									</div>
								</div>
							</div>
						)
