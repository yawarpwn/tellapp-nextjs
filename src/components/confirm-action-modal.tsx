  ...
  return (
    <>
      <Button type="submit" disabled={pending} variant="secondary">
        {pending ? <span className="loading loading-spinner"></span> : 'Aceptar'}
      </Button>
      <Button type="button" disabled={pending} onClick={onClose} variant="secondary">
        Cancelar
      </Button>
    </>
  )
...
function ConfirmModalAction(props: Props) {
